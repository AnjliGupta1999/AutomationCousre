package com.TelecomDomainProject;
 ...
 public void addNewUser() 
 {
	 Response  res=given()
	  ...
	  .body("{ \n"
	  		+ "\"firstName\": \"Anjli\", \n"
	  		+ "\"lastName\": \"Gupta\", \n"
	  		+ "\"email\": \"anjli"+System.currentTimeMillis()+"@gmail.com\", \n"
	  		+ "\"password\": \"test123\" \n"
	  		+ "}")
...
@Test(priority=5)
 ...
 public void getContactList()
 {
	  Response res=given()
			  ...
			  .header("Accept","application/json")
			  .header("Authorization","Bearer "+logintoken)
 .when().get("https://thinking-tester-contact-list.herokuapp.com/contacts");		 res.then().log().body();
